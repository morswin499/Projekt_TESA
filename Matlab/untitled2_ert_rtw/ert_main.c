...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) untitled2_M->Timing.clockTick0;
  untitled2_step();
...
int main(void)
{
  ...
  errorCode = extmodeSetFinalSimulationTime((extmodeSimulationTime_T) 300);
  ...
  errorCode = extmodeInit(untitled2_M->extModeInfo, (extmodeSimulationTime_T *)
    rteiGetPtrTFinalTicks(untitled2_M->extModeInfo));
  if (errorCode != EXTMODE_SUCCESS) {
